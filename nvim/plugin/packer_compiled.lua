...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/copilot-cmp",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/ripgrep",
  ...
  ["telescope-live-grep-args.nvim"] = {
    loaded = true,
    path = "/home/pedro/.local/share/nvim/site/pack/packer/start/telescope-live-grep-args.nvim",
